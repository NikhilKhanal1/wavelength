...
const CATEGORIES = [
  ...
  'How spicy is this food?',
  'How good does this soap scent smell?',
  'How devastating is this injury?',
  'How fun is this domain to grade?',
  'How likeable is this celebrity?',
  'How good of a roommate would this video game character be?',
  'How useful is this superpower day-to-day?',
  'How world-changing is this historical event?',
  'How obscure is this cuisine?',
  'How dangerous would this food be as a weapon?',
  'How good is this World Cup team?',
  'How likely is this type of pet to bite you?',
  'How satisfying is this sound?',
  'How comfortable would this piece of clothing be in summer?',
  'How productive would this animal be as a coworker?',
  'How good would this animal be as a basketball player?',
  'How impressive is this party trick?',
  'How scary is this movie villain?',
  'How tall is this building?',
  'How influenced by AI slop is this platform?',
  'How nostalgic is this decade?',
  'How boring is this sport to watch?',
  'How hard is this cert quiz?',
  'How good was this show\'s finale?',
  'How scary is this phobia?',
  'How looked forward to is this holiday?',
  'How pettable is this animal?',
  'How overrated is this movie?',
  'How overrated is this show?',
  'How complex is this instrument to learn?',
  'How hard is this language to learn?',
  'How smooth to the ears is this instrument\'s sound?',
  'How hard is this video game?',
  'How tall is this celebrity?',
  'How good of a driving instructor would this character be?',
  'How good of a GPS voice would this character be?',
  'How well does this thing float in water?',
  'How willing would you be to drink this liquid?',
  'How easily could you beat this animal in a fight?',
  'How scary is this bug?',
  'How easily could you beat this character in a fight?',
  'How hard is this word to pronounce?',
  'How satisfying is this word to say?',
  'How well known is this painter?',
  'How easy to make is this sandwich?',
  'How pleasant is this city\'s climate?',
  'How likely are you to eat this for $10,000?',
  'How inconvenient would it be to be allergic to this?',
  'How likely is it you would buy this item for $100?',
  'How annoying is this sound to wake up to on a Saturday morning?',
  'How pleasant is this wall color for solitary confinement?',
  'How exhilarating is this thrillseeker activity?',
];
